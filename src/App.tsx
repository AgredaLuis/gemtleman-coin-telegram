...
const App = () => {
  const [points, setPoints] = useState(13000);
    ...
    <div className="bg-gradient-main min-h-screen px-4 flex flex-col items-center text-white font-medium">
      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          ...
          <div className="text-base mt-4 flex items-center gap-2">
        ...
        <div className="fixed bottom-28 w-full px-6 mt-8">
          ...
          <div className="w-full flex justify-center">
            <div className="flex mt-4 max-w-32">
              <img
                src={highVoltage}
                width={44}
                height={44}
        ...
        <div className="fixed bottom-0 w-full px-6 pb-4 z-10">
          <div className="w-full flex justify-center gap-2">
            <div className="flex-grow flex items-center max-w-72 text-sm">
              <div className="w-full bg-[#fad258] py-4 rounded-2xl flex justify-around">
                ...
                <div className="h-[48px] w-[2px] bg-[#fddb6d]"></div>
                <button className="flex flex-col items-center gap-1 mr-1">
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="relative mt-2" onClick={handleClick}>
            <img src={gentleman} width={256} height={256} alt="notcoin" />
            {clicks.map((click) => (
              <div
                key={click.id}
